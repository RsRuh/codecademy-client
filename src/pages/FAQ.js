	...
	<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
		...
		<div className="space-y-4">
			...
			<details className="w-full border rounded-lg cursor-pointer shadow-lg">
				...
				<p className="px-4 py-6 pt-0 ml-4 -mt-4 ">What does useEffect do? By using this Hook, you tell React that your component needs to do something after render. React will remember the function you passed we'll refer to it as our “effect”, and call it later after performing the DOM updates.. </p>
			</details>
			<details className="w-full border rounded-lg cursor-pointer shadow-lg">
