...
const Footer = () => {
    return (
        <footer className="px-4 divide-y mt-5 bg-gray-800 text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                ...
                <img src={brain} className="cursor-pointer" width={34} height={34} viewBox="0 0 34 34" fill="none" alt="" />
				</div>
				<span className="self-center text-2xl font-semibold">Codecademy</span>
			</a>
		</div>
